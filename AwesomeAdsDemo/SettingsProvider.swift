...
class SettingsProvider: NSObject {
    ...
    override init() {
        ...
        self.settingsDict = [
            KEY_PARENTAL_GATE   : SettingsViewModel(item: "settings_controller_row_pg_gate_title".localized,
                                                    details: "settings_controller_row_pg_gate_details".localized,
                                                    value: true),
            KEY_TRANSPARENT_BG  : SettingsViewModel(item: "settings_controller_row_bg_color_title".localized,
                                                    details: "settings_controller_row_bg_color_details".localized,
                                                    value: false),
            KEY_LOCK_PORTRAIT   : SettingsViewModel(item: "settings_controller_row_lock_portrait_title".localized,
                                                    details: "settings_controller_row_lock_portrait_details".localized,
                                                    value: false),
            KEY_LOCK_LANSCAPE   : SettingsViewModel(item: "settings_controller_row_lock_landscape_title".localized,
                                                    details: "settings_controller_row_lock_landscape_details".localized,
                                                    value: false),
            KEY_CLOSE_BUTTON    : SettingsViewModel(item: "settings_controller_row_close_button_title".localized,
                                                    details: "settings_controller_row_close_button_details".localized,
                                                    value: true),
            KEY_AUTO_CLOSE      : SettingsViewModel(item: "settings_controller_row_auto_close_title".localized,
                                                    details: "settings_controller_row_auto_close_details".localized,
                                                    value: false),
            KEY_SMALL_CLICK     : SettingsViewModel(item: "settings_controller_row_small_click_title".localized,
                                                    details: "settings_controller_row_small_click_details".localized,
                                                    value: false),
        ]
    }
